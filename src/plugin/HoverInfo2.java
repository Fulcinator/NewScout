...
public class HoverInfo2
{
	...
	public void paintCaptureForeground(Graphics g)
	{
		...
		if(text!=null)
		{
			drawTextBox(g2, text, x, y, 0, 40, 5);
		}
	}
	...
	private String getHoverText(int mouseX, int mouseY)
	{
		...
		//System.out.println("hovering on " + mouseX + " - " + mouseY);
		Widget widget=StateController.getWidgetAt(StateController.getCurrentState(), mouseX, mouseY);
		//System.out.println("finding widget " + printWidgetNoText(widget));
		if(widget!=null)
		{
			if(widget.getWidgetType()==WidgetType.ACTION)
			{
				...
				{
					action="Click";
					//System.out.println("widget " + widget.getMetadata("id") + " has action click");
